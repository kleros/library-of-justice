  ...
  return (
    ...
    >
      ...
      >
        ...
        <ol
          className={clsx(
            "list-inside list-decimal text-sm text-center sm:text-left",
        ...
        >
          <li className="mb-2">
            ...
            <code
              className={clsx(
                "bg-black/[.05] dark:bg-white/[.06] px-1 py-0.5",
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className={clsx(
              ...
              "dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12",
              "px-4 sm:px-5"
            )}
            href=""
            target="_blank"
          ...
          <a
            className={clsx(
              ...
              "hover:border-transparent text-sm sm:text-base h-10 sm:h-12 px-4",
              "sm:px-5 sm:min-w-44"
            )}
            href=""
            target="_blank"
